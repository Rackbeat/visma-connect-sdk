...
use Rackbeat\VismaConnect\Exceptions\Models\DataFormatInvalidException;
use Rackbeat\VismaConnect\Exceptions\Models\ImmutableOriginalDataException;
use Rackbeat\VismaConnect\Models\Concerns\CastsAttributes;
...
class Model
{
	 ...
	 * @return BaseResource
	 */
	protected function getResourceInstance():BaseResource {
	...
	{
		return $this->getResourceInstance()->delete( $this->getPrimaryKey() );
	}

	// todo move to a trait as not everything can be updated?
	public function update( array $data = [] )
	{
		return $this->getResourceInstance()->update( $this->getPrimaryKey(), $data );
	}
